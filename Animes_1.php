...
<div class="clt"></div>
<div class="clm"><h1><?=$anime['nom']?></h1><img src="<?=$anime['img']?>" title="<?=$anime['nom']?> - Anime Online" width="166" height="250" border="0" class="ii">
...
<!-- face --><div class="bs"><iframe src="http://www.facebook.com/plugins/like.php?href=http://pruebas.animevision.org/<?=$anime['catg']?>/<?=$anime['nom']?>.html&amp;layout=box_count&amp;show_faces=false&amp;width=71&amp;action=like&amp;colorscheme=light&amp;height=65" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:71px; margin-left: -2px; margin-top:1px; height:65px;" allowtransparency="true"></iframe></div><div style="clear:both;"></div>
</div><div style="clear:both;"></div></div>
<div class="clb"></div>
<!-- compartir --><div class="clt"></div><div class="clm"><table align="right" height="34" width="338">
...
<textarea style="width:300px;height:100px" onclick="this.focus();this.select()" readonly="readonly"><iframe src="http://pruebas.animevision.org/embedHentai/<?=$anime['nom']?>/<?=$anime['id']?>.html" width="640" height="540" frameborder="0" allowfullscreen scrolling="no"></iframe></textarea>
